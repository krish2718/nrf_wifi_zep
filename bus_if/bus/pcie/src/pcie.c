...
static int nrf_wifi_bus_pcie_irq_handler(void *data)
{
...
static void *nrf_wifi_bus_pcie_dev_add(void *bus_priv,
								void *bal_dev_ctx)
{
...
static void nrf_wifi_bus_pcie_dev_rem(void *bus_dev_ctx)
{
	struct nrf_wifi_bus_pcie_dev_ctx *pcie_dev_ctx = NULL;
...
static enum nrf_wifi_status nrf_wifi_bus_pcie_dev_init(void *bus_dev_ctx)
{
	enum nrf_wifi_status status = NRF_WIFI_STATUS_FAIL;
	struct nrf_wifi_bus_pcie_dev_ctx *pcie_dev_ctx = NULL;
...
static void nrf_wifi_bus_pcie_dev_deinit(void *bus_dev_ctx)
{
	struct nrf_wifi_bus_pcie_dev_ctx *pcie_dev_ctx = NULL;
...
static void *nrf_wifi_bus_pcie_init(void *params,
...
static void nrf_wifi_bus_pcie_deinit(void *bus_priv)
{
	struct nrf_wifi_bus_pcie_priv *pcie_priv = NULL;
...
static unsigned int nrf_wifi_bus_pcie_read_word(void *dev_ctx,
...
static void nrf_wifi_bus_pcie_write_word(void *dev_ctx,
								  unsigned long addr_offset,
								  unsigned int val)
{
	struct nrf_wifi_bus_pcie_dev_ctx *pcie_dev_ctx = NULL;
...
static void nrf_wifi_bus_pcie_read_block(void *dev_ctx,
								  void *dest_addr,
...
static void nrf_wifi_bus_pcie_write_block(void *dev_ctx,
...
#ifdef INLINE_RX
static unsigned long nrf_wifi_bus_pcie_dma_map_inline_rx(void *dev_ctx,
...
static unsigned long nrf_wifi_bus_pcie_dma_unmap_inline_rx(void *dev_ctx,
...
static unsigned long nrf_wifi_bus_pcie_dma_map(void *dev_ctx,
										unsigned long virt_addr,
										size_t len,
										enum nrf_wifi_osal_dma_dir dma_dir)
{
...
static unsigned long nrf_wifi_bus_pcie_dma_unmap(void *dev_ctx,
										  unsigned long phy_addr,
										  size_t len,
										  enum nrf_wifi_osal_dma_dir dma_dir)
{
...
static void nrf_wifi_bus_pcie_rpu_ps_sleep(void *bus_dev_ctx)
{
...
static void nrf_wifi_bus_pcie_rpu_ps_wake(void *bus_dev_ctx)
{
	unsigned long reg_addr = 0;
	unsigned int reg_val = 0;
...
static int nrf_wifi_bus_pcie_rpu_ps_status(void *bus_dev_ctx)
{
	unsigned long reg_addr = 0;
...
static struct nrf_wifi_bal_ops nrf_wifi_bus_pcie_ops = {
